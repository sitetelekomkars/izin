...
// Scoped click handler for dropdown (prevents conflicts)
...
window.openUserMgmtModal = function () {
    ...
    let html = `
        <div class="mgmt-tabs">
            <button class="mgmt-tab-btn active" onclick="switchMgmtTab('add', event)">➕ Kullanıcı Ekle</button>
            <button class="mgmt-tab-btn" onclick="switchMgmtTab('list', event)">📋 Kullanıcı Listesi</button>
        </div>
